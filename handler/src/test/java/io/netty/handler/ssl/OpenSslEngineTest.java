...
public class OpenSslEngineTest extends SSLEngineTest {
    ...
    public void testWrapWithDifferentSizesTLSv1() throws Exception {
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "ADH-AES128-SHA");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "ADH-CAMELLIA128-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "DES-CBC3-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "AECDH-AES128-SHA");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "DHE-RSA-AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "SEED-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "RC4-MD5");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "ADH-AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "ADH-SEED-SHA");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "DHE-RSA-AES128-SHA");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "DHE-RSA-SEED-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "AECDH-AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "ECDHE-RSA-DES-CBC3-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "ADH-CAMELLIA256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "DHE-RSA-CAMELLIA256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "ECDHE-RSA-AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1, "DHE-RSA-CAMELLIA128-SHA");
    ...
    public void testWrapWithDifferentSizesTLSv1_1() throws Exception {
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "DHE-RSA-AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "DHE-RSA-CAMELLIA256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "ADH-CAMELLIA256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "ADH-AES256-SHA");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "AECDH-AES128-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "DHE-RSA-CAMELLIA128-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "ECDHE-RSA-AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "ADH-AES128-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "ADH-SEED-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_1, "ADH-CAMELLIA128-SHA");
    ...
    public void testWrapWithDifferentSizesTLSv1_2() throws Exception {
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ADH-AES128-SHA");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ADH-CAMELLIA128-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DHE-RSA-AES256-GCM-SHA384");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DES-CBC3-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "AECDH-AES128-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "AES128-GCM-SHA256");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DHE-RSA-AES128-GCM-SHA256");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DHE-RSA-AES256-SHA");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ADH-AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ADH-SEED-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DHE-RSA-AES128-SHA256");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "IDEA-CBC-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DHE-RSA-AES128-SHA");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ADH-AES128-GCM-SHA256");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ADH-AES256-GCM-SHA384");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DHE-RSA-SEED-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DHE-RSA-AES256-SHA256");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "AECDH-AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ECDHE-RSA-DES-CBC3-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ADH-CAMELLIA256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ECDHE-RSA-AES256-GCM-SHA384");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DHE-RSA-CAMELLIA256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ADH-AES256-SHA256");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ADH-AES128-SHA256");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "ECDHE-RSA-AES256-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_TLS_V1_2, "DHE-RSA-CAMELLIA128-SHA");
    ...
    public void testWrapWithDifferentSizesSSLv3() throws Exception {
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_SSL_V3, "AES128-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_SSL_V3, "ADH-CAMELLIA128-SHA");
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_SSL_V3, "DES-CBC3-SHA");
        ...
        testWrapWithDifferentSizes(SslUtils.PROTOCOL_SSL_V3, "AES256-SHA");
